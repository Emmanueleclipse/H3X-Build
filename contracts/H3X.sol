...
// Contract 0x99c8eCC0E37eBf4C6BA849DFe845f6BEAf6807Cc
// Account 0x41B4Ec7527fC507699585903679Da7adA24B523D
contract Work {
	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 5e26; // 
	uint256 constant private BURN_RATE = 15; // 10% per tx
	uint256 constant private SUPPLY_FLOOR = 1; // 1% of 300M = 3M
	uint256 constant private MIN_FREEZE_AMOUNT = 1e20; // 100 minimum

	string constant public name = "Harvest";
	string constant public symbol = "HVT";
	...
	function _transfer(address _from, address _to, uint256 _tokens) internal returns (uint256) {
		...
		if (totalSupply() - _burnedAmount < INITIAL_SUPPLY * SUPPLY_FLOOR / 100 || isWhitelisted(_from)) {
			// will not burn any more if the current total supply is less than 1% of the initial supply
			_burnedAmount = 0;
		}
